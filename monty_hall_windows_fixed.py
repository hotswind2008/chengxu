...
class MontyHallGame:
    ...
    def configure_fonts(self):
        ...
        if self.os_type == 'Windows':
            # Windows系统字体配置
            self.emoji_font_door = ('Segoe UI Emoji', 100)
            self.emoji_font_prize = ('Segoe UI Emoji', 120)
            ...
            # macOS系统字体配置
            self.emoji_font_door = ('Apple Color Emoji', 130)
            self.emoji_font_prize = ('Apple Color Emoji', 150)
